...
(cl:defmethod cl:initialize-instance :after ((m <Tone>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tone)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nxt_lejos_ros_msgs-msg:<Tone> is deprecated: use nxt_lejos_ros_msgs-msg:Tone instead.")))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <Tone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_lejos_ros_msgs-msg:pitch-val is deprecated.  Use nxt_lejos_ros_msgs-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <Tone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_lejos_ros_msgs-msg:duration-val is deprecated.  Use nxt_lejos_ros_msgs-msg:duration instead.")
  (duration m))
