...
(cl:defmethod cl:initialize-instance :after ((m <Battery>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Battery)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nxt_lejos_ros_msgs-msg:<Battery> is deprecated: use nxt_lejos_ros_msgs-msg:Battery instead.")))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <Battery>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_lejos_ros_msgs-msg:voltage-val is deprecated.  Use nxt_lejos_ros_msgs-msg:voltage instead.")
  (voltage m))
