...
(cl:defmethod cl:initialize-instance :after ((m <Decibels>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Decibels)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nxt_lejos_ros_msgs-msg:<Decibels> is deprecated: use nxt_lejos_ros_msgs-msg:Decibels instead.")))

(cl:ensure-generic-function 'decibels-val :lambda-list '(m))
(cl:defmethod decibels-val ((m <Decibels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_lejos_ros_msgs-msg:decibels-val is deprecated.  Use nxt_lejos_ros_msgs-msg:decibels instead.")
  (decibels m))
