...
(cl:defmethod cl:initialize-instance :after ((m <Compass>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Compass)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nxt_lejos_ros_msgs-msg:<Compass> is deprecated: use nxt_lejos_ros_msgs-msg:Compass instead.")))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <Compass>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_lejos_ros_msgs-msg:heading-val is deprecated.  Use nxt_lejos_ros_msgs-msg:heading instead.")
  (heading m))
